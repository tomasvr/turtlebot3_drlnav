...
namespace gazebo
{
  ...
  public:
    void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      key->Translation(ignition::math::Vector3d(-3.5, 1.5, 0.0));
      key->Rotation(ignition::math::Quaterniond(0, 0, 0));

      key = anim->CreateKeyFrame(55);
      key->Translation(ignition::math::Vector3d(-3.5, 3.3, 0.0));
      key->Rotation(ignition::math::Quaterniond(0, 0, 0));

      key = anim->CreateKeyFrame(90);
      key->Translation(ignition::math::Vector3d(-0.6, 3.3, 0.0));
      key->Rotation(ignition::math::Quaterniond(0, 0, 0));

      key = anim->CreateKeyFrame(105);
      key->Translation(ignition::math::Vector3d(-0.6, 2.0, 0.0));
      key->Rotation(ignition::math::Quaterniond(0, 0, 0));
