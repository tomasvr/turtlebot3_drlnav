...
namespace gazebo
{
  class Obstacle11 : public ModelPlugin
  {
  public:
    void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      gazebo::common::PoseAnimationPtr anim(
          ...
          new gazebo::common::PoseAnimation("move11", 110.0, true));
      ...
      key->Translation(ignition::math::Vector3d(1.0, 2.5, 0.0));
      key->Rotation(ignition::math::Quaterniond(0, 0, 0));
  ...
  GZ_REGISTER_MODEL_PLUGIN(Obstacle11)
} // namespace gazebo
